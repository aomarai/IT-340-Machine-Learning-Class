...
class PathFindingAgent(object):
    ...
    def solve(self, start, end, budget):
        ...
        while flag:
            ...
            # basically backtracking, if it gets caught in a dead end it resets itself to the starting city
            if self.route.count(self.current_city) == 2:
                del self.route[-1]
                self.current_city = self.route[0]
                self.route.clear()
...
if __name__ == '__main__':
    ...
    agent.solve('Bucharest', 'Arad', 5000)
